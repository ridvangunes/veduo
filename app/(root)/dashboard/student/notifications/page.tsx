...
const notifications = [
  {
    id: 1,
    title: "Yeni Kurs İçeriği",
    description:
      "Takip ettiğin 'İleri Seviye Next.js' kursuna 3 yeni video eklendi.",
    time: "5 dakika önce",
    type: "enrollment", // instructor uses enrollment for primary
    read: false,
  },
  {
    id: 2,
    ...
    description:
      "'Modern Tasarım Prensipleri' kursunu tamamladın. Sertifikanı hemen indirebilirsin.",
    time: "1 saat önce",
    type: "review", // instructor uses review for amber
    read: false,
  },
  {
    id: 3,
    title: "Yeni Mesaj",
    description:
      "Mert Demir soruna cevap verdi: 'Harika bir soru Arda, detayları dökümanda bulabilirsin.'",
    time: "5 saat önce",
    type: "payment", // instructor uses payment for green
    read: true,
  },
  {
    id: 4,
      ...
      <div className="bg-white rounded-xl border border-border/60 shadow-sm overflow-hidden">
        ...
        <div className="divide-y divide-border/60">
          {notifications.map((notif) => (
            <div
              key={notif.id}
              className={`p-4 hover:bg-slate-50 transition-colors flex gap-4 cursor-pointer group ${!notif.read ? "bg-blue-50/30" : ""}`}
            >
              <div
