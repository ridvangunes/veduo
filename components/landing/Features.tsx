      ...
      <div className="container mx-auto px-6 relative">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <h2 className="text-4xl lg:text-5xl font-black mb-6">
            Neden Veduo'yu Seçmelisiniz?
          </h2>
          <p className="text-slate-400 text-lg">
            Eğitim sürecini kolaylaştıran ve verimliliği artıran benzersiz
            özellikler.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 sm:p-10 bg-white/5 border border-white/10 rounded-[40px] hover:bg-white/10 transition-colors">
            ...
            <p className="text-slate-400 leading-relaxed">
              Kursları başarıyla tamamlayın, global geçerliliği olan
              sertifikalarla CV'nizi güçlendirin.
            </p>
          </div>
          <div className="p-6 sm:p-10 bg-white/5 border border-white/10 rounded-[40px] hover:bg-white/10 transition-colors">
            ...
            <p className="text-slate-400 leading-relaxed">
              İster mobilde ister webde. Çevrimdışı izleme özelliğiyle
              internetiniz olmasa da öğrenmeye devam edin.
            </p>
          </div>
          <div className="p-6 sm:p-10 bg-white/5 border border-white/10 rounded-[40px] hover:bg-white/10 transition-colors">
            ...
            <p className="text-slate-400 leading-relaxed">
              Eğitmenlerle ve diğer öğrencilerle etkileşime geçin. Aklınıza
              takılan her şeyi anında sorun.
            </p>
          </div>
        </div>
      </div>
