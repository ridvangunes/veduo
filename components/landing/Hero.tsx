                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-full mb-6">
                            ...
                            <span className="text-sm font-bold text-blue-700 tracking-wide uppercase">Yeni Nesil Eğitim Platformu</span>
                        </div>
                        <h1 className="text-5xl lg:text-7xl font-black tracking-tight text-slate-900 leading-[1.1] mb-8">
                            Geleceğin <span className="text-blue-600 italic">Yeteneklerini</span> Bugün Keşfedin.
                        </h1>
                        <p className="text-xl text-slate-500 leading-relaxed mb-10 max-w-xl">
                            Dünyanın en iyi eğitmenlerinden, sektör odaklı kurslar. Kariyerinizi bir üst seviyeye taşımak için ihtiyacınız olan her şey burada.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Button variant={"default"} className="px-10 py-6 text-lg group rounded-2xl bg-blue-600 hover:bg-blue-700 cursor-pointer">
                                Eğitimlere Göz At
                                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </Button>
                            <Button variant="secondary" className="px-10 py-6 text-lg border border-slate-900 hover:ring rounded-2xl cursor-pointer">
                                Nasıl Çalışır?
                            </Button>
                        </div>
                        ...
                        <div className="mt-12 flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-bold text-slate-600">4.9/5 Ortalama Puan</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="relative rounded-[48px] overflow-hidden shadow-2xl shadow-blue-900/20 border-8 border-white">
                            ...
                            <div className="absolute bottom-8 left-8 right-8 p-6 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-white font-bold">Web Geliştirme Masterclass</p>
                                        <p className="text-white/70 text-sm">Canlı yayına şimdi katılın</p>
                                    </div>
                                </div>
                            </div>
                        </div>
