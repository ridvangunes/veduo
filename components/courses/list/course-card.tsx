...
export const CourseCard = ({ viewType }: CourseCardProps) => {
  if (viewType === "list") {
    return (
      <Card className="border-slate-100 rounded-3xl p-4 flex flex-col sm:flex-row gap-6 hover:shadow-lg hover:border-slate-200 transition-all group shadow-none">
        <div className="relative w-full sm:w-72 h-44 shrink-0 rounded-2xl overflow-hidden bg-slate-100">
          <Image
        ...
        <div className="grow py-2 flex flex-col">
          <div className="mb-auto">
            ...
            <p className="text-sm text-slate-500 mb-4 line-clamp-2">
              Next.js, TypeScript ve Tailwind CSS kullanarak profesyonel
              seviyede web uygulamaları oluşturun.
            </p>
            <div className="flex items-center gap-4 text-xs font-semibold text-slate-400">
              <span className="flex items-center gap-1">
                <Clock className="w-3.5 h-3.5" /> 24 saat
              </span>
              <span className="flex items-center gap-1">
                <BookOpen className="w-3.5 h-3.5" /> 42 Ders
              </span>
              <span className="flex items-center gap-1">
                <BarChart className="w-3.5 h-3.5" /> Orta Seviye
              </span>
              <span className="flex items-center gap-1">
                <Users className="w-3.5 h-3.5" /> 12,450
              </span>
    ...
    <Card className="border-slate-100 rounded-3xl overflow-hidden hover:shadow-xl hover:border-blue-200 transition-all group shadow-none">
      ...
      <CardContent className="p-5 pb-0">
        <h3 className="font-bold text-slate-900 mb-2 group-hover:text-blue-600 transition-colors line-clamp-2">
          React ile Modern Web Uygulamalı Geliştirme
        </h3>
        ...
        <div className="flex items-center flex-wrap gap-3 text-xs font-semibold text-slate-500 mb-4">
          <span className="flex items-center gap-1">
            <Clock className="w-3.5 h-3.5" /> 24s
          </span>
          <span className="flex items-center gap-1">
            <BookOpen className="w-3.5 h-3.5" /> 42 Ders
          </span>
